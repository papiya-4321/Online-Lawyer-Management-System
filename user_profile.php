									...
									<div class="form-row">
										...
										<div class="form-group col-md-3">
											...
											<select id="city" name="city" class="form-control">
												...
												<option value="Arambagh" <?php if (trim($row['city'])=='Arambagh'){echo "selected";}?>>Arambagh</option>
												<option value="Chinsurah" <?php if (trim($row['city'])=='Chinsurah'){echo "selected";}?>>Chinsurah</option>
												<option value="Barackpore" <?php if (trim($row['city'])=='Barackpore'){echo "selected";}?>>Barackpore</option>
												<option value="Barasat" <?php if (trim($row['city'])=='Barasat'){echo "selected";}?>>Barasat</option>
												<option value="Kolkata" <?php if (trim($row['city'])=='Kolkata'){echo "selected";}?>>Kolkata</option>
												<option value="Bongaon" <?php if (trim($row['city'])=='Bongaon'){echo "selected";}?>>Bongaon</option>
												<option value="Chandannagar" <?php if (trim($row['city'])=='Chandannagar'){echo "selected";}?>>Chandannagar</option>
												<option value="Burdwan" <?php if (trim($row['city'])=='Burdwan'){echo "selected";}?>>Burdwan</option>
											</select>
										</div>
										<div class="form-group col-md-3">
