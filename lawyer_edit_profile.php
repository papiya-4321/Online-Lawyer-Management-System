														...
														<div class="form-row">
															...
															<div class="form-group col-md-3">
																...
																<select id="city" name="city" class="form-control">
																	<option value=" " selected>Choose...</option>
																	<option value="Arambagh" <?php if ($row['city']=='Arambagh'){echo "selected";}?>>Arambagh</option>
																	<option value="Chinsurah" <?php if ($row['city']=='Chinsurah'){echo "selected";}?>>Chinsurah</option>
																	<option value="Barackpore" <?php if ($row['city']=='Barackpore'){echo "selected";}?>>Barackpore</option>
																	<option value="Barasat" <?php if ($row['city']=='Barasat'){echo "selected";}?>>Barasat</option>
																	<option value="Kolkata" <?php if ($row['city']=='Kolkata'){echo "selected";}?>>Kolkata</option>
																	<option value="Bongaon" <?php if ($row['city']=='Bongaon'){echo "selected";}?>>Bongaon</option>
																	<option value="Chandannagar" <?php if ($row['city']=='Chandannagar'){echo "selected";}?>>Chandannagar</option>
																	<option value="Burdwan" <?php if ($row['city']=='Burdwan'){echo "selected";}?>>Burdwan</option>
																</select>
															</div>
															<div class="form-group col-md-3">
