  ...
  color: red;
	...
	<body>
						...
						<nav class="navbar navbar-expand-lg ">
							...
							<div class="collapse navbar-collapse" id="navbarSupportedContent">
								<ul class="navbar-nav ml-auto ">
									...
									<li class="">
										<a class="nav-link cus-a" href="aboutus.php">About Us</a>
									</li>
									<li class="">
		...
		<section class="registerform">
          ...
          <h2>About Us</h2>
              <p>
                  The Lawyer Management System is a web-based platform designed to streamline legal case management and connect clients with experienced lawyers. Our mission is to simplify the legal process by offering easy access to legal professionals, efficient appointment scheduling, and secure document management.
              </p>
              <p>
              Our system ensures responsive design, user-friendliness, and data security. Whether you're a lawyer looking to manage cases or a client in need of legal advice, we aim to provide a reliable and effective legal support environment.
              </p>
