			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 ml-auto">
						<h1>About US</h1>
						<p>The Lawyer Management System is a web-based platform designed to streamline legal case management and connect clients with experienced lawyers. Our mission is to simplify the legal process by offering easy access to legal professionals, efficient appointment scheduling, and secure document management.</p>
						<p>This is user-friendliness, and data security. Whether you're a lawyer looking to manage cases or a client in need of legal advice, we aim to provide a reliable and effective legal support environment.
						</p>
					</div>
					<div class="col-md-6">
